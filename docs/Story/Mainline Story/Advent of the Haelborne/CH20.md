...
All in all, it took long enough for him to finish the monsters I decided to step in so we’d be back before sundown. It was a good lot of cooked meat though. We began walking back an hour to starset.
...
It blotted out the stars. It painted the sky blood. It shattered the brain and triggered instincts and we ran.
...
-   :material-book:{ .lg .middle } __Previous__
    ...
    [:octicons-arrow-left-24: Chapter XIX: Twisted Little Hearts](CH20.md)

-   :material-book:{ .lg .middle } __Next__

    ---

    [:octicons-arrow-right-24: Chapter XXI: Discussing the Belly](CH21.md)
